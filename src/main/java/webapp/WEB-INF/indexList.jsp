...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugin/jquery.auto-complete/jquery.auto-complete.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugin/superfish/css/superfish.css" media="screen">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugin/superfish/css/superfish-vertical.css" media="screen">
    ...
    <script src="${pageContext.request.contextPath}/plugin/laypage-v1.3/laypage/laypage.js"></script>
            ...
            <div class="l-box">
                ...
                <div class="form-box form-wrapper">
                    <form action="${pageContext.request.contextPath }/index" method="post">
                        <input id="keyword" class="sr" name="keyword" type="text" value="请输入关键词"/>
                ...
                <div id="list" class="rela">
                    <c:forEach items="${ zhwses}" var="zhws">
                       <table class="table table-striped">
	                      <tr>
	                       <th><a href="${pageContext.request.contextPath }/get/${zhws.id}"><label>${zhws.m_tm}</label></a></th>
	                      </tr> 
	                      <tr>
                ...
                <!--分页导航开始-->
                <div id="page" class="mt10 text-center">
